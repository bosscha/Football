  ...
  #block(
    ...
    [
      ...
      #text(fill: rgb("#ffd0d6"), size: 8pt)[
        Modélisation Monte-Carlo (100000 saisons simulées) | Calendrier Officiel LFP (34 journées) | Modèle Bilan 25/26, UEFA & Transfermarkt
      ]
    ]
  )
]
...
#grid(
  ...
  [
    #block(fill: light_bg, inset: 8pt, radius: 4pt, stroke: 0.4pt + border_color, width: 100%)[
      ...
      - *Intervalle 50% (P25 - P75)* : [31 - 40 pts]
      - *Victoires / Nuls / Déf.* : *9.6V - 7.0N - 17.4D*
      - *Buts marqués / concédés* : *43.7 BP / 66.3 BC*
      - *Différence de buts moyenne* : *-22.6*
    ]
  ],
  [
    #block(fill: light_bg, inset: 8pt, radius: 4pt, stroke: 0.4pt + border_color, width: 100%)[
  ...
  [
    #block(fill: light_bg, inset: 8pt, radius: 4pt, stroke: 0.4pt + border_color, width: 100%)[
      ...
      #table(
        ...
        stroke: none,
        [*Maintien Direct (1-15)*], [*81.4%*], [#text(fill: win_green, weight: "bold")[Favorable]],
        [*Barrage (16e place)*], [*8.2%*], [#text(fill: rgb("#d69e2e"), weight: "bold")[Alerte]],
        [*Relégation (17-18e)*], [*10.5%*], [#text(fill: loss_red, weight: "bold")[Risque]],
        [*Total Risque Relég.*], [*18.6%*], [#text(fill: dark_navy)[(Barr. + Rel.)]],
        [*Top 10 Ligue 1*], [*22.2%*], [#text(fill: accent_blue)[Première moitié]],
...
#grid(
  ...
  [
    #table(
      ...
      [5e], [0.07%], [0.1%], [Ligue Europa (C3)],
      [6e], [0.21%], [0.3%], [Ligue Confér. (C4)],
      [7e], [0.85%], [1.2%], [Milieu haut],
      [8e], [3.24%], [4.4%], [Milieu haut],
      [9e], [7.57%], [12.0%], [Milieu haut],
      [10e], [10.23%], [22.2%], [Milieu haut],
      [11e], [12.17%], [34.4%], [Maintien direct],
      [#text(fill: brest_red, weight: "bold")[12e ★]], [12.85%], [47.2%], [Maintien direct],
      [13e], [12.60%], [59.8%], [Maintien direct],
      [14e], [11.58%], [71.4%], [Maintien direct],
      [15e], [9.96%], [81.4%], [Maintien direct],
      [16e], [8.17%], [89.5%], [Barragiste (L2)],
      [17e], [6.25%], [95.8%], [Relégation directe],
      [18e], [4.21%], [100.0%], [Relégation directe],
    )
  ],
  [
    #align(center)[
...
#table(
  ...
  [J01], [2026-08-22], [Le Mans FC vs *Brest* (E)], [Stade Marie-Marvingt], [1.48–1.54], [*1 - 1* (N)], [1 - 1 (11.2%)], [39.0%], [24.4%], [36.7%], [1.41], [1.4], 
  [J02], [2026-08-29], [*Brest* vs Toulouse FC (D)], [Francis-Le Blé], [1.53–1.48], [*1 - 1* (N)], [1 - 1 (11.3%)], [38.8%], [24.2%], [37.0%], [1.41], [2.8], 
  [J03], [2026-09-05], [Le Havre AC vs *Brest* (E)], [Stade Océane], [1.52–1.49], [*1 - 1* (N)], [1 - 1 (11.3%)], [37.1%], [24.5%], [38.4%], [1.36], [4.2], 
  [J04], [2026-09-12], [*Brest* vs Paris Saint-Germain (D)], [Francis-Le Blé], [0.61–3.74], [*0 - 3* (D)], [0 - 3 (11.2%)], [2.7%], [6.4%], [90.9%], [0.14], [4.3], 
  [J05], [2026-09-19], [AJ Auxerre vs *Brest* (E)], [Stade de l'Abbé-Deschamps], [1.55–1.47], [*1 - 1* (N)], [1 - 1 (11.1%)], [36.0%], [24.3%], [39.8%], [1.32], [5.6], 
  [J06], [2026-09-26], [*Brest* vs Angers SCO (D)], [Francis-Le Blé], [1.87–1.22], [*2 - 1* (V)], [1 - 1 (10.3%)], [52.9%], [22.6%], [24.6%], [1.81], [7.5], 
  [J07], [2026-10-03], [LOSC Lille vs *Brest* (E)], [Decathlon Arena - Stade Pierre-Mauroy], [2.74–0.83], [*2 - 0* (D)], [2 - 0 (10.7%)], [8.7%], [13.8%], [77.5%], [0.40], [7.9], 
  [J08], [2026-10-17], [*Brest* vs OGC Nice (D)], [Francis-Le Blé], [1.58–1.44], [*1 - 1* (N)], [1 - 1 (11.1%)], [41.1%], [24.4%], [34.5%], [1.48], [9.3], 
  [J09], [2026-10-24], [FC Lorient vs *Brest* (E)], [Stade du Moustoir], [1.70–1.34], [*1 - 1* (N)], [1 - 1 (10.9%)], [30.2%], [23.5%], [46.3%], [1.14], [10.5], 
  [J10], [2026-10-31], [*Brest* vs Olympique lyonnais (D)], [Francis-Le Blé], [1.13–2.00], [*1 - 2* (D)], [1 - 2 (9.8%)], [21.0%], [21.4%], [57.6%], [0.84], [11.3], 
  [J11], [2026-11-07], [RC Strasbourg vs *Brest* (E)], [Stade de la Meinau], [2.08–1.09], [*2 - 1* (D)], [2 - 1 (9.8%)], [19.1%], [20.6%], [60.2%], [0.78], [12.1], 
  [J12], [2026-11-21], [*Brest* vs Paris FC (D)], [Francis-Le Blé], [1.61–1.41], [*1 - 1* (N)], [1 - 1 (11.1%)], [42.2%], [24.0%], [33.8%], [1.51], [13.6], 
  [J13], [2026-11-28], [Stade rennais FC vs *Brest* (E)], [Roazhon Park], [2.37–0.96], [*2 - 1* (D)], [2 - 0 (10.0%)], [13.4%], [17.6%], [68.9%], [0.58], [14.2], 
  [J14], [2026-12-05], [*Brest* vs ESTAC Troyes (D)], [Francis-Le Blé], [1.78–1.27], [*1 - 1* (N)], [1 - 1 (10.6%)], [49.5%], [23.1%], [27.4%], [1.72], [15.9], 
  [J15], [2026-12-12], [*Brest* vs Olympique de Marseille (D)], [Francis-Le Blé], [1.07–2.11], [*1 - 2* (D)], [1 - 2 (10.0%)], [18.2%], [20.5%], [61.3%], [0.75], [16.6], 
  [J16], [2026-12-19], [AS Monaco vs *Brest* (E)], [Stade Louis-II], [2.47–0.92], [*2 - 1* (D)], [2 - 0 (10.1%)], [12.0%], [16.7%], [71.4%], [0.53], [17.2], 
  [J17], [2027-01-09], [RC Lens vs *Brest* (E)], [Stade Bollaert-Delelis], [2.57–0.88], [*2 - 0* (D)], [2 - 0 (10.3%)], [10.9%], [15.5%], [73.6%], [0.48], [17.7], 
)
...
#table(
  ...
  [J18], [2027-01-16], [*Brest* vs RC Strasbourg (D)], [Francis-Le Blé], [1.36–1.67], [*1 - 1* (N)], [1 - 1 (11.0%)], [31.4%], [24.0%], [44.7%], [1.18], [18.8], 
  [J19], [2027-01-23], [OGC Nice vs *Brest* (E)], [Allianz Riviera], [1.27–1.79], [*1 - 1* (N)], [1 - 1 (10.6%)], [27.4%], [23.0%], [49.5%], [1.05], [19.9], 
  [J20], [2027-01-30], [*Brest* vs Stade rennais FC (D)], [Francis-Le Blé], [1.19–1.90], [*1 - 2* (D)], [1 - 1 (10.1%)], [23.6%], [22.1%], [54.2%], [0.93], [20.8], 
  [J21], [2027-02-06], [Paris Saint-Germain vs *Brest* (E)], [Parc des Princes], [0.49–4.66], [*4 - 0* (D)], [7 - 0 (11.7%)], [0.9%], [2.8%], [96.3%], [0.05], [20.9], 
  [J22], [2027-02-13], [*Brest* vs AS Monaco (D)], [Francis-Le Blé], [1.14–1.99], [*1 - 2* (D)], [1 - 1 (10.0%)], [21.4%], [21.7%], [56.9%], [0.86], [21.7], 
  [J23], [2027-02-20], [Paris FC vs *Brest* (E)], [Stade Jean-Bouin], [1.29–1.76], [*1 - 1* (N)], [1 - 1 (10.8%)], [28.3%], [23.3%], [48.4%], [1.08], [22.8], 
  [J24], [2027-02-27], [*Brest* vs LOSC Lille (D)], [Francis-Le Blé], [1.03–2.20], [*1 - 2* (D)], [1 - 2 (9.8%)], [16.6%], [19.4%], [64.0%], [0.69], [23.5], 
  [J25], [2027-03-06], [Toulouse FC vs *Brest* (E)], [Stadium de Toulouse], [1.23–1.85], [*2 - 1* (D)], [1 - 1 (10.4%)], [25.0%], [22.8%], [52.2%], [0.98], [24.5], 
  [J26], [2027-03-13], [*Brest* vs FC Lorient (D)], [Francis-Le Blé], [1.66–1.36], [*1 - 1* (N)], [1 - 1 (11.0%)], [44.3%], [24.0%], [31.7%], [1.57], [26.1], 
  [J27], [2027-03-20], [Olympique de Marseille vs *Brest* (E)], [Orange Vélodrome], [0.86–2.63], [*2 - 0* (D)], [2 - 0 (10.6%)], [9.9%], [14.9%], [75.2%], [0.45], [26.5], 
  [J28], [2027-04-03], [*Brest* vs Le Mans FC (D)], [Francis-Le Blé], [1.92–1.18], [*2 - 1* (V)], [1 - 1 (10.2%)], [54.5%], [22.2%], [23.3%], [1.86], [28.4], 
  [J29], [2027-04-10], [Olympique lyonnais vs *Brest* (E)], [Groupama Stadium], [0.91–2.50], [*2 - 1* (D)], [2 - 0 (10.3%)], [11.6%], [16.5%], [71.9%], [0.51], [28.9], 
  [J30], [2027-04-17], [ESTAC Troyes vs *Brest* (E)], [Stade de l'Aube], [1.43–1.59], [*1 - 1* (N)], [1 - 1 (11.0%)], [34.6%], [23.9%], [41.5%], [1.28], [30.1], 
  [J31], [2027-04-24], [*Brest* vs AJ Auxerre (D)], [Francis-Le Blé], [1.83–1.24], [*2 - 1* (V)], [1 - 1 (10.5%)], [51.1%], [22.9%], [26.0%], [1.76], [31.9], 
  [J32], [2027-05-01], [*Brest* vs Le Havre AC (D)], [Francis-Le Blé], [1.86–1.22], [*2 - 1* (V)], [1 - 1 (10.4%)], [52.4%], [22.7%], [24.9%], [1.80], [33.7], 
  [J33], [2027-05-08], [Angers SCO vs *Brest* (E)], [Stade Raymond-Kopa], [1.50–1.51], [*1 - 1* (N)], [1 - 1 (11.4%)], [37.5%], [24.5%], [38.0%], [1.37], [35.1], 
  [J34], [2027-05-22], [*Brest* vs RC Lens (D)], [Francis-Le Blé], [1.10–2.07], [*1 - 2* (D)], [1 - 2 (10.0%)], [19.4%], [20.6%], [60.0%], [0.79], [35.9], 
)
...
#table(
  ...
  [Le Mans FC], [J01 (E) Méd. 1-1 (N)], [J28 (D) Méd. 2-1 (V)], [*3.27*], [#text(fill: win_green, weight: "bold")[Opportunité majeure (6 pts ciblés)]],
  ...
  [AJ Auxerre], [J05 (E) Méd. 1-1 (N)], [J31 (D) Méd. 2-1 (V)], [*3.08*], [#text(fill: accent_blue, weight: "medium")[Concurrent direct / Équilibré]],
  [ESTAC Troyes], [J14 (D) Méd. 1-1 (N)], [J30 (E) Méd. 1-1 (N)], [*2.99*], [#text(fill: accent_blue, weight: "medium")[Concurrent direct / Équilibré]],
  [FC Lorient], [J09 (E) Méd. 1-1 (N)], [J26 (D) Méd. 1-1 (N)], [*2.71*], [#text(fill: accent_blue, weight: "medium")[Concurrent direct / Équilibré]],
  [Paris FC], [J12 (D) Méd. 1-1 (N)], [J23 (E) Méd. 1-1 (N)], [*2.59*], [#text(fill: accent_blue, weight: "medium")[Concurrent direct / Équilibré]],
  [OGC Nice], [J08 (D) Méd. 1-1 (N)], [J19 (E) Méd. 1-1 (N)], [*2.53*], [#text(fill: accent_blue, weight: "medium")[Concurrent direct / Équilibré]],
  [Toulouse FC], [J02 (D) Méd. 1-1 (N)], [J25 (E) Méd. 1-2 (D)], [*2.39*], [#text(fill: rgb("#d69e2e"))[Adversaire supérieur / Défi]],
  [RC Strasbourg], [J11 (E) Méd. 1-2 (D)], [J18 (D) Méd. 1-1 (N)], [*1.96*], [#text(fill: rgb("#d69e2e"))[Adversaire supérieur / Défi]],
  [Stade rennais FC], [J13 (E) Méd. 1-2 (D)], [J20 (D) Méd. 1-2 (D)], [*1.51*], [#text(fill: loss_red)[Cador européen / Match difficile]],
  [AS Monaco], [J16 (E) Méd. 1-2 (D)], [J22 (D) Méd. 1-2 (D)], [*1.38*], [#text(fill: loss_red)[Cador européen / Match difficile]],
